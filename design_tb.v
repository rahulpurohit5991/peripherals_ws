...
module uart_tb;
  ...
  uart_tx uart_tx_inst (
    ...
    .idle(tx_idle),
    .tx(tx),
    .tick_baud_x16(1'b0),    // Unused input connected to 0
    .parity_enable(1'b0),    // Unused input connected to 0
    .wr_parity()             // Unused output left unconnected
  );
  ...
  uart_rx uart_rx_inst (
    ...
    .tick_baud_x16(1'b0),    // Unused input connected to 0
    .parity_enable(1'b0),    // Unused input connected to 0
    .parity_odd(1'b0),       // Unused input connected to 0
    .tick_baud(1'b0),        // Unused input connected to 0
    .idle(),                 // Unused output left unconnected
    .frame_err(),            // Unused output left unconnected
    .rx_parity_err()         // Unused output left unconnected
  );
